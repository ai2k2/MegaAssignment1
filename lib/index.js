...
const exhaustDisposal = (report, disposal, lotStack, localCurrency) => {
  ...
  const lotToPush = lotToDiminish.set('assetAmount', lotToDiminish.assetAmount.minus(disposal.assetAmount)).set('basisAmount', lotToDiminish.basisAmount.minus(costBa
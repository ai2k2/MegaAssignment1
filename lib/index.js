...
const lotsAndDisposalsFromLost = ({
  ...
  const updatedTransactionsMap = transactionsMap.set(txId, transactionsMap.get(txId).set('tx_type', 'WITHDRAWAL').set('withdrawal_code', transactionsMap.getIn([txId, 'lost_code'])).set('withdrawal_amount', transactionsMap.getIn([txId, 'lost_amount'